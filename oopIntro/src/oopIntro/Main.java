...
public class Main {
	...
	public static void main(String[] args) {
		...
		Product product1 = new Product(); // örnek oluþturma, referans oluþturma, instance creation(alma)
		product1.setId(2);
		...
		productManager.addToCart(product1); // product'ýn bellek adresini göndermiþ oluyoruz.
...
// kümülatif bir ürün listesi oluþtu.

// persistancy = kalýcý demek. db de tutmak demek 
