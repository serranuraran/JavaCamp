...
// constructor : bir nesnenin referansını bellekte oluşturduğu
// zaman(newlediğinde) çalışan blokdu.
...
// class ikiye ayrılıyor. : is yapan classlar. özellik içeren classlar. yapı
// aynı. isimlendirme farklı

// get=> okuma (readonly)
// set=> yazma
// c# daki get; set; kavramının karşılığı java da yok. biz bunları getter ve
// setter ile hallediyoruz.

// final => dışardan erişimi kapatır. sadece consturctorda set edilebilir demek.
// private=> özel, sadece bu classın içinde kullanılabilir demek.